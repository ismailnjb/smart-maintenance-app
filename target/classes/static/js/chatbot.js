jQuery(document).ready(function($) {
    ...
    $(document).on("submit", "#messenger", function(e) {
        ...
        if (val.indexOf("hello") > -1 || val.indexOf("hi") > -1 || val.indexOf("good morning") > -1 || val.indexOf("good afternoon") > -1 || val.indexOf("good evening") > -1 || val.indexOf("good night") > -1) {
            ...
            if (val.indexOf("water pump") > -1 || val.indexOf("wp") > -1) {

                appendMsg("I'm sorry to hear that you're experiencing an issue with your water pump. Water pump problems can be quite inconvenient. To address this, you may want to consider contacting a plumber who specializes in water pump repairs. They can diagnose the issue, whether it's a malfunctioning pump, a leak, or another problem, and provide you with the necessary repairs or replacements. If you'd like, I can help you find a local plumber in your area. Just let me know your location, and I'll provide you with some options.");
                appendMsg("is it helpful? (yes/no)");

            } else if (val.indexOf("vending machine") > -1 || val.indexOf("vm") > -1) {
                appendMsg("I'm sorry to hear about the problem with your vending machine. To get it fixed, consider reaching out to a vending machine technician or service provider who specializes in vending machine repairs. They can diagnose and resolve the issue for you.");
                appendMsg("is it helpful? (yes/no)");
            } else {
